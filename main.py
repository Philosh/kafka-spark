...
exploded_df = (
    json_expanded_df.select(
        "customerId", "eventId", "eventOffset", "eventPublisher", "eventTime", "data"
    )
...
agg_df = (
    flattened_df.withColumn("eventDate", to_date("eventTime", "yyyy-MM-dd"))
